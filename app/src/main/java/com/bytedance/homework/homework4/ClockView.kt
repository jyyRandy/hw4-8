...
class ClockView @JvmOverloads constructor(
    ...
    private var wPaint: Paint = Paint().apply {
        color = Color.parseColor("#FF5C5353")
        style = Paint.Style.FILL
        isAntiAlias = true
        strokeWidth = 6F
    }
    ...
    private val ox: Float = 500F
    private val oy: Float = 1000F
    private val r: Float = 500F
    private var hdeg: Double = 180.0
    private var mdeg: Double = 270.0
    private var sdeg: Double = 270.0
